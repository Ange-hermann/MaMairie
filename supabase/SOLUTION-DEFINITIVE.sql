-- ============================================
-- SOLUTION DÉFINITIVE - TOUT CORRIGER
-- ============================================

-- ÉTAPE 1 : Créer l'enum sexe s'il n'existe pas
DO $$ 
BEGIN
...
-- ÉTAPE 2 : Ajouter la colonne sexe si elle n'existe pas
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
        WHERE table_name = 'naissances' AND column_name = 'sexe'
    ) THEN
        ALTER TABLE naissances ADD COLUMN sexe sexe_enum;
    END IF;
END $$;

-- ÉTAPE 3 : Supprimer et recréer la fonction
...
BEGIN
  ...
  -- 3. Convertir le sexe AVANT l'INSERT
...
-- VÉRIFICATIONS
SELECT '✅ Enum sexe créé' as etape_1;
SELECT '✅ Colonne sexe ajoutée' as etape_2;
SELECT '✅ Fonction créée' as etape_3;
SELECT '✅ TOUT EST PRÊT !' as resultat;
